...
export default function HistoryPage() {
  const { trades, cashflows, dividends, settings, activePortfolioId, defaultPortfolioId, ipoEvents, ipoEntries } = useData();
  ...
  const initialCapitalForMarket = activePortfolioId === defaultPortfolioId
  ...
  const allTimelineItems = useMemo<TimelineItem[]>(() => {
    ...
    closedTrades.forEach((trade: any) => {
      items.push({
        ...
        portfolioId: trade.portfolioId || defaultPortfolioId,
    ...
    marketCashflows.forEach((cashflow: any) => {
      items.push({
        ...
        portfolioId: cashflow.portfolioId || defaultPortfolioId,
    ...
    marketDividends.forEach((dividend: any) => {
      ...
      items.push({
        ...
        portfolioId: dividend.portfolioId || defaultPortfolioId,
    ...
    if (activeTab === 'ID' && activePortfolioId === defaultPortfolioId) {
  ...
  }, [activePortfolioId, activeTab, closedTrades, defaultPortfolioId, formatMoney, ipoEntries, ipoEvents, marketCashflows, marketDividends]);
