...
function reduceJournalRows(rows) {
  ...
  result.trades.sort((a, b) => new Date(b.dateBuy || b.createdAt || 0).getTime() - new Date(a.dateBuy || a.createdAt || 0).getTime());
  result.watchlist.sort((a, b) => new Date(b.createdAt || 0).getTime() - new Date(a.createdAt || 0).getTime());
  result.notes.sort((a, b) => new Date(b.createdAt || 0).getTime() - new Date(a.createdAt || 0).getTime());
  result.cashflows.sort((a, b) => new Date(b.createdAt || 0).getTime() - new Date(a.createdAt || 0).getTime());
  result.dividends.sort((a, b) => new Date(b.createdAt || 0).getTime() - new Date(a.createdAt || 0).getTime());
