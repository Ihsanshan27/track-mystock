...
export default function TradeDetailPage() {
  ...
  // Sync editing + form to context draft whenever they change
  useEffect(() => {
    if (editing) {
      setTradeEditDraft({ tradeId: id, editing, form });
    }
    // If not editing, don't wipe out a draft that might exist from another trade
  }, [form, editing, id, setTradeEditDraft]);
